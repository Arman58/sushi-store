...
export const metadata: Metadata = {
    title: "Контакты",
    description: `Телефон, адрес кухни и время работы ${SITE_NAME}. Доставка суши, пиццы и шаурмы в Ереване и Котайке.`,
                ...
                >
                    ...
                    >
                        <Stack spacing={1} alignItems="center" textAlign="center" sx={{ mb: 3.5 }}>
                            ...
                            >
                                Звоните, забирайте сами или заказывайте доставку по Еревану и
                                Котайку.
                            </Typography>
                        </Stack>
                        ...
                        <Stack spacing={3} divider={<Divider flexItem />}>
                            <ContactRow
                                ...
                                hint="Для заказа и уточнения времени доставки."
                            />
                            ...
                            <ContactRow
                                ...
                                hint="Самовывоз и база для доставки по Нор Ачин, Котайку и Еревану."
                            />
                            ...
                            <ContactRow
                                ...
                                hint="Принимаем заказы каждый день без выходных."
                            />
                        </Stack>
