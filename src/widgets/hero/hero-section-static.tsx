...
export type HeroSectionStaticProps = {
...
/**
 * Hero shell — серверный компонент (без useTranslations / client boundary).
 * LCP-картинка и текст в первом HTML-чанке.
 */
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Box sx={{ mb: 4 }}>
                    <HeroOrderButton label={orderNowLabel} />
                </Box>
